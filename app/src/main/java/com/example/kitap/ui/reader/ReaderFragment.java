...
public class ReaderFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        args.putString("fileName", rParam);
        fragment.setArguments(args);

        if (getArguments() != null) {
            rArgs = getArguments().getString("fileName");
            Log.d("Reader Fragment", "onCreate: " + rArgs);
        }

        File dir = new File(getActivity().getApplicationContext().getFilesDir().getPath() + "/Kitap/" + rArgs);
